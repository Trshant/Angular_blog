...
angular.module('appServices', [])
		...
		.factory('data', function(){
			return data = [
				{date: new Date(2013, 4,02) , link: "lorem_ipsum_translated.html" , title:"Lorem Ipsum" , tags:["Lorem Ipsum", "Tranlated Lorem"]},
				{date: new Date(2013, 6,02) , link: "only_lorem.html" , title:"Only Lorem Ipsum" , tags:["Lorem Ipsum","lorem Only"]},
				{date: new Date(2013,11,02) , link: "post3.html" , title:"post3" , tags:["code"]},
				{date: new Date(2014, 0,28) , link: "crossfilterd3js.html" , title:"D3 and Crossfilter" , tags:["JavaScript", "d3.js", "crossfilter.js"]},
				...
				{date: new Date(2015,01,02) , link: "onbeforeunload.html" , title:"Browser event to catch closing/changing pages" , tags:["JavaScript", "browser"]}
			] ;
		}
